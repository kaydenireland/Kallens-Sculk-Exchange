...
@Mod(KallensSculkExpanse.MODID)
public class KallensSculkExpanse {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "kse";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "kse" namespace
    public KallensSculkExpanse(IEventBus modEventBus, ModContainer modContainer) {
